#+TITLE: Abstractive Summarization and Extractive Generalization with NLP. 2022-10033-Standard Purchase Framework Agreement-Livedata Ltd-AI Researchers-P2021-065. Draft (3) report
...
* Intro
# CLARIFY John: A one-page executive summary (possibly in bullets) would be helpful to the reader
...
The University of Manchester’s National Centre for Text Mining (NaCTeM) is one of the world’s foremost NLP research centres with extensive industry collaboration experience.
...
The company  wishes to develop, in collaboration with NaCTeM, additional features that would customise
the returned risk factors for the deal the user is working on:
...
** Experimentation
# TODO: Add a bit code explanation 
...
# Manu: I guess, graphs in 4.1.1 and 4.1.2 are not self-explanatory. Adding more text content under the image will make it more explainable. Indicating what x-axis/y-axis data is, and a short explanation on what the figure is about and how to read it, and what the visualisation is about etc.
*** Abstractive summarisation
Below, you can see the result of BERT-based /transformers/ and /SpaCy-based/ absractive summarisation models.

#+caption: Abstractive summarisation similarity metrics
#+BEGIN_center
